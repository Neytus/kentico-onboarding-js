# onboardingAPI OpenAPI Specification
[![Build Status](https://travis-ci.org/Neytus/kentico-onboarding-js.svg?branch=master)](https://travis-ci.org/Neytus/kentico-onboarding-js)
...
6. If you did everything correct, https://neytus.github.io/kentico-onboarding-js/ will lead to your new docs
...
- Documentation(ReDoc): https://neytus.github.io/kentico-onboarding-js/
- SwaggerUI: https://neytus.github.io/kentico-onboarding-js/swagger-ui/
- Look full spec:
    + JSON https://neytus.github.io/kentico-onboarding-js/swagger.json
    + YAML https://neytus.github.io/kentico-onboarding-js/swagger.yaml
- Preview spec version for branch `[branch]`: https://neytus.github.io/kentico-onboarding-js/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://neytus.github.io/kentico-onboarding-js/ with url from the message: `Server started <url>`
