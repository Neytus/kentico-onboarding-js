...
const mapStateToProps = ({ nodesList: { nodes, nodesInfo, nodesIds } }, { id }) => ({
  nodeViewModel: createMemoizedNodeViewModel(nodes.get(id), nodesInfo.get(id), nodesIds.indexOf(id)),
});
